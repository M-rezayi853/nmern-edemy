...
export const login = async (req, res) => {
  try {
    ...
    // return user and token client, exclude hashed password
...
//   // console.log('send email useing SES')
//   // res.json({ ok: true })
//   const params = {
//     Source: process.env.EMAIL_FROM,
//     Destination: {
//       ToAddresses: ['mahdi.rezayi.853@gmail.com']
//     },
...
//               <p>Please use the following link to your password</p>
//             </html>
//           `
//         }
//       },
